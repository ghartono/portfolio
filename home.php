<html><head>
    <title>Gionaldo Hartono's Portfolio</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" integrity="sha384-WskhaSGFgHYWDcbwN70/dfYBj47jz9qbsMId/iRN3ewGhXQFZCSftd1LZCfmhktB" crossorigin="anonymous">
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro|Spectral+SC|Spectral" rel="stylesheet">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.0.13/css/all.css" integrity="sha384-DNOHZ68U8hZfKXOrtjWvjxusGo9WQnrNx2sqG0tfsghAvtVlRW3tvkXWZh58N9jp" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="/stylesheet/css/fonts.css">
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js" integrity="sha384-smHYKdLADwkXOn1EmN1qk/HfnUcbVRZyYmZ4qpPea6sjB/pTJ0euyQp0Mk8ck+5T" crossorigin="anonymous"></script><style></style>
</head>
<body>


<header id="top">
    <div class="container font-header row">
        <div class="logo col-md-6 col-xs-12 col-sm-12">
            <a href="/" class="nohover">Gionaldo Hartono</a>
        </div>
    ...
    <div class="container">
      <div class="row top-buffer">
        ...
        <div class="col-xs-12 col-sm-12 offset-md-3 col-md-6">
            <p><b>Language &amp; runtime</b><br>
            HTML/CSS, PHP, JavaScript, Java, C++, Ruby, NodeJS</p>
            <p><b>Frameworks</b><br>
            Laravel, Rails, Bootstrap, CodeIgniter</p>
            <p><b>Database</b><br>
            MySQL, PostgreSQL</p>
            <p><b>OS</b><br>
            Windows, Linux, MacOS</p>
            <p><b>Others</b><br>
            Github, Heroku, VMWare, VirtualBox</p>
        </div>
      </div>
...
<footer>
    <div class="container font-header row">
        <!--
        <div class="col-md-6">    
        <nav class="col-xs-hidden col-md-visible">
                <ul>
                    <li><a class="nohover" href="/resume">Resume</a></li>
                    <li><a class="nohover" href="/project">Projects</a></li>
                    <li><a class="nohover" href="/blog">Blog</a></li>
                    <li><a class="nohover" href="/contact">Contact</a></li>
                </ul>
            </nav>
        </div>
        -->
        <div class="col-xs-12 col-sm-12 offset-md-4 col-md-4 center top-buffer">
